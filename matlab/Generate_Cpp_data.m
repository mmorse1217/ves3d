  ...
  for ii = 1:length(varargin)
    ...
    switch varargin{ii}
     case 'SpHarmRot'
      ...
      save([fileName '.txt'],'R','-ascii','-double');
     ...
     case 'SingularIntegralWeights'
      ...
      save(fileName,'sqw','-ascii', '-double');
     ...
     case 'WSpherical'
      ...
      save(fileName,'w_sph','-ascii', '-double');
...
% save(fileName,'centers','-ascii', '-double');
