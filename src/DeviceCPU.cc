...
void  DeviceCPU<T>::InitializeSHT(int p, int p_up)
{
    ...
    sprintf(leg_trans_fname    ,   "%s/precomputed/legTrans%u_single.txt",getenv("VES3D_DIR"),p_);
    sprintf(leg_trans_inv_fname,"%s/precomputed/legTransInv%u_single.txt",getenv("VES3D_DIR"),p_);
    sprintf(d1_leg_trans_fname , "%s/precomputed/d1legTrans%u_single.txt",getenv("VES3D_DIR"),p_);
    sprintf(d2_leg_trans_fname , "%s/precomputed/d2legTrans%u_single.txt",getenv("VES3D_DIR"),p_);
    ...
    sprintf(leg_trans_fname    ,   "%s/precomputed/legTrans%u_single.txt",getenv("VES3D_DIR"),p_up_);
    sprintf(leg_trans_inv_fname,"%s/precomputed/legTransInv%u_single.txt",getenv("VES3D_DIR"),p_up_);
    sprintf(d1_leg_trans_fname , "%s/precomputed/d1legTrans%u_single.txt",getenv("VES3D_DIR"),p_up_);
    sprintf(d2_leg_trans_fname , "%s/precomputed/d2legTrans%u_single.txt",getenv("VES3D_DIR"),p_up_);
