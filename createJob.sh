#!/bin/bash
#input executablename [jobfile_suffix] [walltime (min)] [OMP_NUM_THREADS] [label]

######################################################################
######################################################################
# This is an example script. Since the content is highly dependent on#
# the platform, please do not edit this file. Instead make a copy    # 
# (createJob.hostname for instance) and edit that locally.           #
######################################################################
######################################################################
